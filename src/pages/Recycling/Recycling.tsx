...
const Recycling: React.FC = () => (
  <BackgroundWithHeader justifyContent="space-between" nameIcon="arrow-back">
    <TopInfoContainer>
      <TopInfoCardContainer>
        <TextComponent fontFamily="Lato-Bold" fontSize={4.2} textAlign="center">
          12
        </TextComponent>
    ...
    <CardInfoItemsContainer>
      <ColumnsCardContainer>
        <CardColumnContainer>
          ...
          <ItemInfoCardContainer>
            <MaterialIcons name="computer" size={24} color={Colors.blueGray} />
            <TextComponent
              marginLeft={3}
              fontFamily="Lato-Regular"
              fontSize={1.2}
    ...
    <BottomInfoContainer>
      ...
      <LineBottomContainer>
        <CardBottomInfoContainer>
          ...
          <TextComponent textAlign="center" color={Colors.gray} fontSize={1.25}>
